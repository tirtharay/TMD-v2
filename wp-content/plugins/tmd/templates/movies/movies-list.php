<div class="all-movies-list">
    ...
    foreach ($moviesdata as $movies) {
        ...
        echo '<span class="releasedate">' . tmdb_date($movies->release_date) . '</span>';
    ...
    echo getmoviespagination($total_results, $displayCount, $currentpage, 5, $post_slug);
...
function getmoviespagination($total, $displayCount, $currentPage, $displayPageList, $slug)
{
